...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x=100, y=3, width=500, height=450)

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=700, y=70, width=400, height=400)

        self.T = tk.Label(self.root)
        self.T.place(x=60, y=5)
        self.T.config(text="Sign Language To Text Convertor", font=("Courier", 30, "bold"))

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=280, y=485)

        self.T1 = tk.Label(self.root)
        self.T1.place(x=10, y=480)
        self.T1.config(text="Character :", font=("Courier", 30, "bold"))

        self.panel5 = tk.Label(self.root)  # Sentence
        self.panel5.place(x=260, y=532)

        self.T3 = tk.Label(self.root)
        self.T3.place(x=10, y=532)
        ...
        self.b1.place(x=390,y=600)

        self.b2 = tk.Button(self.root)
        self.b2.place(x=590, y=600)

        self.b3 = tk.Button(self.root)
        self.b3.place(x=790, y=600)

        self.b4 = tk.Button(self.root)
        self.b4.place(x=990, y=600)
